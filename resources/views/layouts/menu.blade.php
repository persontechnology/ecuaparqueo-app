    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <!-- Main -->
                <li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Principal</div> <i class="icon-menu" title="Principal"></i></li>
                <li class="nav-item">
                    <a href="{{ route('home') }}" class="nav-link {{ request()->routeIs(['home','welcome'])?'active':'' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('departamentos') }}" class="nav-link {{ request()->routeIs('departamentos*')?'active':'' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('vehiculos') }}" class="nav-link {{ request()->routeIs('vehiculos*')?'active':'' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('roles') }}" class="nav-link {{ request()->routeIs(['roles','permisos'])?'active':'' }}">
                        <i class="icon-lock"></i>
                        <span>
                            Roles y permisos
                        </span>
