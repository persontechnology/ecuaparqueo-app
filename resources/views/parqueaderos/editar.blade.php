    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input id="descripcion" type="text" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" value="{{ old('descripcion',$parqueadero->descripcion) }}" >
            ...
            <div class="form-group">
                ...
                <input id="numero_total" type="number" class="form-control @error('numero_total') is-invalid @enderror" name="numero_total" value="{{ old('numero_total',$parqueadero->numero_total) }}" >
