...
class OrdenMovilizacionDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('estado',function($orden){
                return view('movilizacion.control.action',['orden'=>$orden])->render();
            })
     ...
     *
     * @param \App\Models\Movilizacion/OrdenMovilizacion $model
    ...
    protected function getColumns()
    {
        return [
            ...
            //       ->width(60)
            //     //   ->searchable(false)
            //       ->title('ACEPTAR o DENEGAR')
            //       ->addClass('text-center'),
            // Column::make('id'),
            Column::make('estado')->title('Aceptar/Denegar'),
    ...
    {
        return 'Movilizacion_OrdenMovilizacion_' . date('YmdHis');
    }
}
